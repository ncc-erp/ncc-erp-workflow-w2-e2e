Feature: WFH Request
  ...
  Rule: As pm, I want to received a WFH Request from my project
    ...
    Scenario: I can approve the request success
      When I approve request by title "*global[wfhRequest2].getTitle" with strength points "" and weekness points ""
  ...
  Rule: As GDVP, I want to received a WFH Request after PM approved
    Background:
      ...
      And "PM" approve the request "*global[wfhRequest3].getTitle" with strength points "" and weekness points "" success, current state "PM Reviews"
      And I am on "TaskPage"
    ...
    Scenario: I can approve the request success
      When I approve request by title "*global[wfhRequest3].getTitle" with strength points "" and weekness points ""
  ...
  Rule: As user, I want to see a WFH after PM, GDVP approved
    Background:
      ...
      And "PM" approve the request "*global[wfhRequest4].getTitle" with strength points "" and weekness points "" success, current state "PM Reviews"
      And "GDVPDN" approve the request "*global[wfhRequest4].getTitle" with strength points "" and weekness points "" success, current state "Branch Manager Reviews"

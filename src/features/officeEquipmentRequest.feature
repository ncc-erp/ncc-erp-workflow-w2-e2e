Feature: Office Equipment Request
  ...
  Rule: As gdvp, I want to received an Office Equipment Request from my office
    ...
    Scenario: I can approve the request success
      When I approve request by title "*global[oer1].getTitle"
  ...
  Rule: As it, I want to received an Office Equipment Request after gdvp approved
    Background:
      ...
      And "GDVPDN" approve the request "*global[oer2].getTitle" success and current state "Branch Manager Reviews"
      And I am on "TaskPage"
    ...
    Scenario: I can approve the request success
      When I approve request by title "*global[oer2].getTitle"
  ...
  Rule: As user, I want to see an Office Equipment Request after it approved
    Background:
      ...
      And "GDVPDN" approve the request "*global[oer3].getTitle" success and current state "Branch Manager Reviews"
      And "it" approve the request "*global[oer3].getTitle" success and current state "IT Reviews"

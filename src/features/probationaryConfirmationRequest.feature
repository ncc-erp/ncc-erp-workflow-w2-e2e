Feature: Probationary Confirmation Request
  ...
  @gdvpdn
  Rule: As GDVPDN, I want to received a Probationary Confirmation Request from my project
    ...
    Scenario: I can approve the request success
      ...
      Then I should see request is "approve" with id "*global[pcr1].response.id" and state "HoO Reviews" on tasks page

    Scenario: I can reject the request success
      When I reject request with id "*global[pcr1].response.id" with reason "test reason"
      Then I should see request is "reject" with id "*global[pcr1].response.id" and state "HoO Reviews" on tasks page
  ...
  Rule: As gdvp, I want to received a Probationary Confirmation Request from my office
    ...
    Scenario: I should see the request with pending status on my tasks
      ...
      And I should see a komu notification sent to "*testData.users.gdvpdn.username" with message "*global[pcr2].getKomuMessage"
  ...
  Rule: As ceo, I want to received a Probationary Confirmation Request after pm, gdvp approved
    ...
    Scenario: I should see the request with pending status on my tasks
      ...
      And I should see a komu notification sent to "*testData.users.ceo.username" with message "*global[pcr3].getKomuMessage"

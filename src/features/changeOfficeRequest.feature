Feature: Change Office Request
  ...
  Rule: As pm, I want to received a Change Office Request from my project
    ...
    Scenario: I can approve the request success
      When I approve request by title "__globalData[co1].getTitle"
      Then I should see request is "approve" with title "__globalData[co1].getTitle" and state "PM Reviews" on tasks page
  ...
  Rule: As gdvp, I want to received a Change Office Request from my office
    ...
    Scenario: I can approve the request success
      When I approve request by title "__globalData[co2].getTitle"
      Then I should see request is "approve" with title "__globalData[co2].getTitle" and state "Current HoO Reviews" on tasks page

    Scenario: I can reject the request success
      When I reject request by title "__globalData[co2].getTitle" with reason "test reason"
  ...
  Rule: As gdvp, I want to received a Change Office Request if anyone come to my office
    ...
    Scenario: I can approve the request success
      When I approve request by title "__globalData[co3].getTitle"
      Then I should see request is "approve" with title "__globalData[co3].getTitle" and state "Destination HoO Reviews" on tasks page

    Scenario: I can reject the request success
      When I reject request by title "__globalData[co3].getTitle" with reason "test reason"
      Then I should see request is "reject" with title "__globalData[co3].getTitle" and state "Destination HoO Reviews" on tasks page
    @user
  Rule: As user, I want to see a Change Office Request after PM, GDVP1, GDVP2 approved
    Background:
      Given User create "Change Office Request" with "__testData[random_change_office_request]__global-co4" success
      And "PM" approve the request "__globalData[co4].getTitle" success
      And "GDVPDN" approve the request "__globalData[co4].getTitle" success
      And "GDVPV" approve the request "__globalData[co4].getTitle" success

    Scenario: I should see the request with approved status on my requests
      When I am on "MyRequestPage"
      Then I should see "__globalData[co4].getTitle" with status "Approved" on my request page